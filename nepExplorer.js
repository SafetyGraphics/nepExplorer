(function (global, factory) {
    ...
    function styles() {
      var styles = ['.wc-framework {', '    width: 100%;', '    display: inline-block;', '}', '.wc-hidden {', '    display: none !important;', '}', '.wc-invisible {', '    visibility: hidden;', '}', '.wc-column {', '    display: inline-block;', '}', '.wc-section {', '    display: inline-block;', '    width: 100%;', '}', '.wc-component {', '    display: inline-block;', '    width: 100%;', '}', '.wc-header {', '    border-top: 2px solid black;', '    border-bottom: 2px solid black;', '    padding: 0.2em;', '    font-weight: bold;', '}', '.wc-subcomponent {', '    width: 50%;', '}', '.wc-chart {', '    width: 80%;', '    display: inline-block;', '}',
      /***--------------------------------------------------------------------------------------\
      column: left
      \--------------------------------------------------------------------------------------***/
      ...
      /*****----------------------------------------------------------------------------\
        component: details
      \----------------------------------------------------------------------------*****/
      '.wc-component__details-clear {', '    float: right;', '    margin: 0.5em;', '}', '.wc-subcomponent__details-participant {', '    list-style: none;', '    padding: 0;', '}', '.wc-details__li {', '    display: inline-block;', '    text-align: center;', '    padding: 0.5em;', '}', '.wc-details__label {', '    font-size: 0.8em;', '}', '.wc-details__value {', '}',
      /*****----------------------------------------------------------------------------\
    ...
    function updatePopCount() {
      this.controls.popCount.html("<span class = 'numerator'>".concat(this.filtered_data.length, "</span> of <span class = 'numerator'>").concat(this.raw_data.length, "</span> participants shown."));
    }
    ...
    function metadata() {
      ...
      var metadata = this.config.kdigo_criteria.slice().sort(function (a, b) {
        return a.x - b.x;
      }).map(function (d, i) {
        var next = i < _this.config.kdigo_criteria.length - 1 ? _this.config.kdigo_criteria[i + 1] : {
          x: _this.x_dom[1],
          y: _this.y_dom[1]
        };
    ...
    function addKdigoLegend() {
      ...
      if (this.kdigoLegend) this.kdigoLegend.draw(this.kdigoSummary);else {
