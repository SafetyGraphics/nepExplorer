(function (global, factory) {
    ...
    function addKdigoLegend() {
      ...
      if (this.kdigoLegend.initialized) this.kdigoLegend.draw(this.data.kdigoSummary);else this.kdigoLegend.init(this.data.kdigoSummary);
    }
    ...
    function nepExplorer() {
      ...
      Object.keys(configuration.timeSeriesCharts).forEach(function (chart) {
        ...
        nepExplorer.containers["".concat(chart, "Header")] = nepExplorer.containers["".concat(chart, "Container")].append('div').classed("wc-header wc-header--".concat(chart), true).text(syncedSettings.title);
