(function (global, factory) {
    ...
    function styles() {
      ...
      \----------------------------------------------------------------------------*****/
      '.wc-component--kdigo {', '}', '.wc-subcomponent--kdigo-scatter-plot {', '    position: relative;', '}', '.wc-subcomponent--kdigo-scatter-plot circle.wc-hover-mark,', '.wc-subcomponent--kdigo-scatter-plot circle.wc-data-mark {', '    cursor: pointer;', '}', '.wc-subcomponent--kdigo-scatter-plot circle.wc-data-mark {', '    stroke: black;', '    fill-opacity: 1;', '    stroke-width: 1;', '}', 'circle.wc-data-mark:hover,', 'circle.wc-data-mark.wc-highlighted,', 'circle.wc-data-mark.wc-selected {', '    stroke-width: 3;', '    stroke: black;', '}', '.kdigo-stage {', '    stroke: black;', '}', '.wc-subcomponent--kdigo-scatter-plot .tick line {', '    stroke-opacity: .4;', '}', '.wc-subcomponent--kdigo-scatter-plot .legend--kdigo {', '    height: 20px;', '    margin: 8px 0px;', '}', '.wc-subcomponent__legend {', '    position: absolute;', //'    top: 14;',
      //'    bottom: 0;',
    ...
    function drawVoronoiDiagram() {
      ...
      var hoverMarks = mark.groups.filter(function (d) {
      ...
      }).insert('circle', ':first-child').classed('wc-hover-mark', true).attr('clip-path', function (d) {
        ...
        return _this.y(d.values.y);
      }).attr('r', 50).style('fill', 'lightblue').style('pointer-events', 'all').style('fill-opacity', 0);
    ...
    function defineVisitLevelData() {
      ...
      var visits = studydays.map(function (studyday) {
        ...
        visitObj.kdigo = kdigo ? kdigo.label.replace(/stage_(\d)/, 'Stage $1 AKI').replace('no_aki', 'No AKI') : '???';
        return visitObj;
      }).sort(function (a, b) {
